...
export function LegalLanguageNotice({ documentType }: LegalLanguageNoticeProps) {
 ...
 className="text-sm font-medium text-amber-700 underline underline-offset-2 hover:text-amber-900 transition-colors"
 >
 ...
 {summary && (
 <div className="mt-3 rounded-lg bg-white/70 border border-amber-100 p-4">
 <p className="text-xs font-medium text-amber-600 mb-2 uppercase tracking-wider">
