...
import {
  CalendarDays, Clock, MapPin, Star, ChevronRight, Inbox
} from 'lucide-react'
...
export default function ClientBookingsPage() {
  ...
  useEffect(() => {
    async function loadBookings() {
      ...
      const completedIds = bookingData
      ...
      const items: BookingListItem[] = bookingData.map(b => {
        ...
        return {
          ...
          has_review: reviewedBookingIds.includes(b.id),
        }
      })
