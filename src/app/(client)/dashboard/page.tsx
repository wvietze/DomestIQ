...
const notificationIconMap: Record<string, IconConfig> = {
 ...
 system_alert: { icon: Bell, bgColor: 'bg-muted', iconColor: 'text-muted-foreground' },
}

const defaultIconConfig: IconConfig = { icon: Bell, bgColor: 'bg-muted', iconColor: 'text-muted-foreground' }
...
export default function ClientDashboard() {
 ...
 <div className="w-9 h-9 mx-auto bg-emerald-50 rounded-full flex items-center justify-center mb-1.5">
 ...
 <Card>
 <CardContent className="p-3 text-center">
 <div className="w-9 h-9 mx-auto bg-pink-50 rounded-full flex items-center justify-center mb-1.5">
 ...
 <Card>
 <CardContent className="p-3 text-center">
 <div className="w-9 h-9 mx-auto bg-violet-50 rounded-full flex items-center justify-center mb-1.5">
