...
export default function WorkerProfilePage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center border-4 border-background shadow-sm">
 ...
 <div key={ws.services.id} className="flex items-center justify-between py-2.5 border-b border-border last:border-0">
 ...
 <AvatarFallback className="bg-muted text-xs">{review.profiles.full_name[0]}</AvatarFallback>
 </Avatar>
 <div>
 ...
 {/* Sticky Book Now CTA */}
 <div className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-lg border-t border-border p-4 z-30">
 <div className="max-w-2xl mx-auto flex gap-3">
 <FavoriteButton workerId={id} size="md"className="h-12 w-12 border border-border rounded-xl"/>
