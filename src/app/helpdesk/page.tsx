...
export default function HelpdeskRegistrationPage() {
 ...
 {/* Credentials Card */}
 <div className="bg-background rounded-3xl border-2 border-emerald-200 shadow-2xl overflow-hidden">
 {/* Card header */}
...
"p-5 text-base rounded-2xl border-2 transition-all text-center active:scale-95",
 ...
 {/* Header */}
 <div className="bg-background/80 backdrop-blur-sm border-b px-6 py-4 flex items-center justify-between">
 <div className="flex items-center gap-3">
 ...
 {/* Bottom Navigation */}
 <div className="fixed bottom-0 left-0 right-0 bg-background/90 backdrop-blur-sm border-t p-5">
