...
const mockData: WorkerProfileViewData = {
 ...
 portfolio: [
 { id: 'p1', worker_profile_id: 'demo-wp-1', image_url: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop', caption: 'Garden transformation', service_id: 'gardener', sort_order: 0, created_at: '2024-06-01' },
 { id: 'p2', worker_profile_id: 'demo-wp-1', image_url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=600&fit=crop', caption: 'Kitchen deep clean', service_id: 'domestic-worker', sort_order: 1, created_at: '2024-06-10' },
 { id: 'p3', worker_profile_id: 'demo-wp-1', image_url: 'https://images.unsplash.com/photo-1527515637462-cee1cc710eed?w=600&h=600&fit=crop', caption: 'Sparkling windows', service_id: 'window-cleaner', sort_order: 2, created_at: '2024-07-01' },
 ],
 reviews: [
 {
