...
const animations = [
  {
    name: 'Logo Pulse',
    description: 'DomestIQ logo with emerald glow ring — brand presence',
    component: LogoPulse,
  },
  {
    name: 'Service Icons Orbit',
    description: 'Home, garden & repair icons orbit — "we cover many services"',
    component: OrbitDots,
  },
  {
    name: 'House Build',
    description: 'Roof, walls, door & heart draw in stages — "building trust in your home"',
    component: HouseBuild,
  },
  {
    name: 'Sunrise Bars',
    description: 'Bars rise with amber-to-emerald gradient — "new day, new opportunity"',
    component: WaveBars,
  },
  {
    name: 'Shield Verify',
    description: 'Shield draws itself, checkmark appears — "verified workers"',
    component: GradientSpinner,
  },
  {
    name: 'Hands Connect',
    description: 'Two hands slide together and clasp — "connecting workers & households"',
    component: MorphingShapes,
  },
  {
    name: 'Profile Build',
    description: 'Avatar, name & stars assemble a profile card — "building your profile"',
    component: StackingBlocks,
  },
  {
    name: 'Location Pulse',
    description: 'Map pin with expanding ripples — "finding workers near you"',
    component: RippleRings,
  },
  {
    name: 'Service Bounce',
    description: 'Home, garden & repair icons bounce in sequence — "services at your fingertips"',
    component: BouncingDots,
  },
  {
    name: 'Sunrise Arc',
    description: 'Amber arc rises over emerald horizon — "dawn of opportunity"',
