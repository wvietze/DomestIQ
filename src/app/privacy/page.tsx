...
export default function PrivacyPage() {
 ...
 <div className="bg-blue-50 rounded-xl p-6 border border-blue-200 not-prose mb-6">
 ...
 <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200 not-prose mt-6">
 ...
 <th className="text-left px-4 py-3 font-semibold text-foreground border-b border-slate-200">Data Category</th>
 <th className="text-left px-4 py-3 font-semibold text-foreground border-b border-slate-200">Retention Period</th>
 </tr>
 </thead>
